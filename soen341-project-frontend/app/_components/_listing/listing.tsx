...
export default function Listing() {
  ...
  const handleRequestVisit = async (House: any) => {
    setSelectedHouse(House);
    console.log(House);
    const reserve = await axios.post('http://localhost:3001/reservation/reserve', {ReserveeId: userId, BrokerId: House.BrokerId});
